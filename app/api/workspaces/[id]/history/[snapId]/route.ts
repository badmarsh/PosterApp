          ...
          data: {
            ...
            cards: {
              create: output.cards.map((c) => ({
                ...
                pattern: c.pattern,
                content: c.content,
                table: c.table === null || c.table === undefined ? (Prisma as any).DbNull : (c.table as any),
                figures: c.figures === null || c.figures === undefined ? (Prisma as any).DbNull : (c.figures as any),
                figureLayout: c.figureLayout,
                sourceIds: c.sourceIds === null || c.sourceIds === undefined ? (Prisma as any).DbNull : (c.sourceIds as any),
