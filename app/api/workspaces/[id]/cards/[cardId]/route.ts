...
export async function PUT(
  ...
  try {
    ...
    const data = {
      ...
      table: card.table === null || card.table === undefined ? (Prisma as any).DbNull : (card.table as any),
      figures: card.figures === null || card.figures === undefined ? (Prisma as any).DbNull : (card.figures as any),
      figureLayout: card.figureLayout || "single",
      sourceIds: card.sourceIds === null || card.sourceIds === undefined ? (Prisma as any).DbNull : (card.sourceIds as any),
      grounding: card.grounding === null || card.grounding === undefined ? (Prisma as any).DbNull : (card.grounding as any),
