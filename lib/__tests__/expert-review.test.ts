      ...
      [
        {
          ...
          severity: "minor",
          category: "results",
          evidence: [{ evidenceType: "quote", quote: "presnosťou 94.5% na CIFAR-10" }],
        },
      ],
      sampleRAG
    )
      ...
      [
        {
          ...
          severity: "minor",
          category: "results",
          evidence: [{ evidenceType: "quote", quote: "Model  dosiahol   výrazné   zlepšenie" }],
        },
      ],
      sampleRAG
    )
      ...
      [
        {
          ...
          severity: "minor",
          category: "methodology",
          evidence: [{ evidenceType: "quote", quote: "Trénovanie prebiehalo s learning rate 1e-4" }],
        },
      ],
      sampleRAG
    )
      ...
      [
        {
          ...
          severity: "major",
          category: "results",
          evidence: [{ evidenceType: "quote", quote: "Použili sme kvantový počítač D-Wave s 5000 qubitmi." }],
        },
      ],
      sampleRAG
    )
