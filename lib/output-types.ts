...
export const TEMPLATE_REGISTRY: TemplateDef[] = [
  ...
  { id: "conference",  outputType: "poster", label: "Conference Modern",  description: "High-impact, publication-ready conference poster with sleek cards and stat callouts.", category: "core",
    colors: [{id:"indigo",name:"Indigo",hex:"#4F46E5"},{id:"cyan",name:"Cyan",hex:"#0284C7"},{id:"emerald",name:"Emerald",hex:"#059669"},{id:"crimson",name:"Crimson",hex:"#DC2626"}], layoutPreview: "poster-3col",
    detailFeatures: ["Modern publication-grade conference layout", "Sleek title header with venue and author badges", "Refined cards with subtle accent borders", "Native support for hero stat metrics & booktabs"], latexClass: "tikzposter", colorSystem: "Custom \\definecolorstyle" },
  ...
  { id: "epj-woc",      outputType: "paper", label: "EPJ Web of Conferences", description: "Standard HEP conference proceedings (CHEP, Quark Matter).", category: "institutional",
    ...
    detailFeatures: ["EPJ Web of Conferences proceedings format", "Single-column layout", "Author/institute blocks with email", "Bundled webofc class"], latexClass: "webofc", colorSystem: "None" },
  { id: "iopart",       outputType: "paper", label: "IOP (iopart)",           description: "IOP Publishing journals (J. Phys. series, Meas. Sci. Technol.).", category: "core",
    ...
    detailFeatures: ["IOP Publishing journal format", "Single-column layout", "\\address block for affiliations", "Bundled iopart class"], latexClass: "iopart", colorSystem: "None" },
  // ML / CS conferences
  { id: "neurips",      outputType: "paper", label: "NeurIPS",                description: "NeurIPS single-column camera-ready format.", category: "core",
    ...
    detailFeatures: ["NeurIPS single-column layout", "'final' option prints author names", "Do not use figure* — single column", "Bundled neurips_2026 style"], latexClass: "article + neurips_2026", colorSystem: "None" },
  { id: "icml",         outputType: "paper", label: "ICML",                   description: "ICML two-column format with icmlauthorlist front matter.", category: "core",
    ...
    detailFeatures: ["ICML two-column layout", "'accepted' option de-anonymises", "Figures span columns via figure*", "Bundled icml2026 style"], latexClass: "article + icml2026", colorSystem: "None" },
  { id: "iclr",         outputType: "paper", label: "ICLR",                   description: "ICLR single-column conference format.", category: "core",
    ...
    detailFeatures: ["ICLR single-column layout", "Times body font", "Do not use figure* — single column", "Bundled iclr2026 style"], latexClass: "article + iclr2026_conference", colorSystem: "None" },
  { id: "acl",          outputType: "paper", label: "ACL / EMNLP / NAACL",    description: "ACL Rolling Review two-column NLP format.", category: "core",
    ...
    detailFeatures: ["Shared ACL/EMNLP/NAACL style", "Two-column layout with microtype", "Figures span columns via figure*", "Bundled acl style"], latexClass: "article + acl", colorSystem: "None" },
  { id: "cvpr",         outputType: "paper", label: "CVPR / ICCV",            description: "CVPR two-column camera-ready format.", category: "core",
    ...
    detailFeatures: ["CVPR/ICCV two-column layout", "'final' camera-ready (no line numbers)", "Figures span columns via figure*", "Bundled cvpr style"], latexClass: "article + cvpr", colorSystem: "None" },
  { id: "aaai",         outputType: "paper", label: "AAAI",                   description: "AAAI two-column format. Forbids hyperref/geometry/fancyhdr.", category: "core",
    ...
    detailFeatures: ["AAAI two-column layout", "Style forbids hyperref/geometry/fancyhdr", "Figures span columns via figure*", "Bundled aaai2026 style"], latexClass: "article + aaai2026", colorSystem: "None" },
