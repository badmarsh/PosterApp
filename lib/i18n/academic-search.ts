...
const STRINGS = {
  en: {
    ...
    searchFailedHint: "The literature connectors did not respond. Check your connection and try again.",
  ...
  sk: {
    ...
    searchFailed: "Vyhľadávanie sa nepodarilo dokončiť",
    searchFailedHint: "Literárne konektory neodpovedali. Skontrolujte pripojenie a skúste to znova.",
  ...
  cs: {
    ...
    searchFailed: "Vyhledávání se nepodařilo dokončit",
    searchFailedHint: "Literární konektory neodpověděly. Zkontrolujte připojení a zkuste to znova.",
