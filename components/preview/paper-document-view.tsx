...
export function PaperDocumentView({
  ...
  return (
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-2 px-5 py-6 pb-20">
      ...
      <div className="mb-3 flex items-center gap-2"><BookOpen className="size-4 text-primary" /><span className="text-[13px] font-bold">Paper Sections</span><span className="rounded-full bg-muted px-2 py-px font-mono text-[10px] text-muted-foreground">{cards.length}</span></div>
